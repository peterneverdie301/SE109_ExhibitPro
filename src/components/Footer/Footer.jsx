         ...
         <div className="konsept-container flex flex-col justify-between py-4 my-4 space-y-4 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3 order-2 lg:order-1 hidden lg:block">
               <div className="lg:ml-16 h-14">
                  <img
                     className="h-full"
                     src="https://scontent.xx.fbcdn.net/v/t1.15752-9/355322174_3309490486018051_4104103625329913687_n.png?stp=dst-png_p403x403&_nc_cat=108&ccb=1-7&_nc_sid=aee45a&_nc_ohc=yoO1YaemtO4AX_o5adE&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdRxHeaiKY5fB24QfhX_jG80oyoj4USvMycSHJoYdbiMoQ&oe=64BA4C16"
                     alt="logo"
            ...
            <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 order-1 lg:order-2">
               <div className="space-y-3">
                  ...
                  <ul className="space-y-1">
                     ...
                     <li>
                        <a
                           className="font-poppins text-base text-konsept-gray"
                           href="https://www.canary.com.vn/chandung"
                        >
                           Portrait painting
                        </a>
                     </li>
               ...
               <div className="space-y-3 ml-2">
                  ...
                  <div className="flex justify-start space-x-3">
                     <a
                        href="https://www.facebook.com/impeter301/"
                        title="Facebook"
                     ...
                     <a
                        href="https://discord.gg/kGzeM3tw"
                        title="Github"
                        className="flex items-center p-1 social-icon"
                     >
                        <GithubIcon />
